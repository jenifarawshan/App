...
public class ProductDAO {
    ...
    public void addProduct(ProductDTO product) throws SQLException, ClassNotFoundException {
        ...
        String insertQuery = "INSERT INTO m_product (product_name, price, register_datetime, update_datetime) VALUES (?, ?, NOW(), NOW())";
    ...
    public void updateProduct(ProductDTO product) throws SQLException, ClassNotFoundException {
        ...
        String updateQuery = "UPDATE m_product SET product_name = ?, price = ? WHERE product_code = ? AND delete_datetime IS NULL AND product_code NOT IN (SELECT product_code FROM t_sales)";
    ...
    public void updateProductName(ProductDTO product) throws SQLException, ClassNotFoundException {
        ...
        String updateQuery = "UPDATE m_product SET product_name = ? WHERE product_code = ? AND delete_datetime IS NULL";
        PreparedStatement preparedStatement = conn.prepareStatement(updateQuery);
        preparedStatement.setString(1, product.getProductName());
        preparedStatement.setInt(3, product.getProductCode());
        preparedStatement.executeUpdate();
    ...
    public void deleteProduct(int productCode) throws SQLException, ClassNotFoundException {
        ...
        String updateQuery = "UPDATE m_product SET delete_datetime = NOW() WHERE product_code = ? AND delete_datetime IS NULL AND product_code NOT IN (SELECT product_code FROM t_sales) ";
        PreparedStatement preparedStatement = conn.prepareStatement(updateQuery);
