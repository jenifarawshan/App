...
<table>
    ...
    %>
        <tr>
            ...
            <td><a href='/app/products/update/<%= productCode %>'><button class='edit-button'>操作</button></a></td>
        </tr>
    <%
        }
    %>
...
<button class="add-product-button" onclick="location.href='products/add'">製品を追加する</button>
